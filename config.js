...
config.skillLevels.advanced.value = 80;
config.skillLevels.intermediate.value = 65;
config.skillLevels.beginner.value = 30;
...
config.sections.work = "Experience professionnelle";
config.sections.volunteer = "Volontariat";
config.sections.education = "Formation";
config.sections.awards = "Récompenses";
config.sections.publications = "Publications";
config.sections.skills = "Compétences";
config.sections.languages = "Langues";
config.sections.interests = "Intérêts";
config.sections.references = "Références";
